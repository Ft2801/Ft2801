...
My goal is to apply computer science knowledge in complex contexts, developing efficient and scalable solutions with a focus on **Data Analysis**, **AI**, and **Software Engineering**.
...
| **Gruppo Astrofili Pescaresi Website** | Complete refactoring of my amateur astronomers association website. | `HTML` `CSS` `JavaScript` `JavaScript` |
...
* **Software Focus:** Siril, PixInsight, Tstar.
